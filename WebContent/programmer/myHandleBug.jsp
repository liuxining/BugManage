...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="col-md-12">
			<form class="am-form-horizontal" action="${pageContext.request.contextPath}/HandleBugServlet?method=leaderListHandleBugList&to=programmer_myHandleBug" method="post">
				<div class="row-fluid">
					<div class="col-sm-3">
					...
					<input type="hidden" name="userId" value="${loginUserBean.id }" />					
					<div class="col-sm-3">
...
<div class="container-fluid">
	  <div class="am-cf am-padding am-padding-bottom-0">
	    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">我的解决方案</strong> / <small>列表</small></div>
	  </div>
	<div class="row-fluid">
...
<!-- 					<td>
					...
					<div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
	                      ...
	                      <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" href="${pageContext.request.contextPath}/HandleBugServlet?method=leaderListHandleBugDelete&id=${item.id}&bugId=${bugId}&pass=${pass}&userId=${loginUserBean.id}&page=${page}&to=programmer_myHandleBug" onclick="return confirm('确定删除吗？')"><span class="am-icon-trash-o"></span> 删除</a>
	                    </div>
                 	</div>
					</td>
